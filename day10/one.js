...
// 전치연산
let incFirst = 10;
console.log("1", incFirst);
++incFirst;
console.log("2", incFirst);
console.log("3", ++incFirst);
console.log("4", incFirst);

let decFirst = 10;
console.log("dec1", decFirst);
--decFirst;
console.log("dec2", decFirst);
console.log("dec3", --decFirst);
console.log("dec4", decFirst);
